...
public class FirstPersonController : MonoBehaviour
{
    ...
    [SerializeField] private bool willSliderOnSlopes = true;
    [SerializeField] private bool canZomm = true;
    ...
    private Coroutine zoomRountine;
    ...
    private void HandleZoom()
    {
        ...
        {
            if (zoomRountine != null)
            {
                StopCoroutine(zoomRountine);
                zoomRountine = null;
            }

            zoomRountine = StartCoroutine(ToggleZoom(true));
        }
        ...
        if (Input.GetKeyUp(zoomKey))
        {
            ...
            zoomRountine = StartCoroutine(ToggleZoom(false));
        }
    ...
    private void ApplyFinalMovements()
    {
        ...
        if (willSliderOnSlopes && IsSliding)
